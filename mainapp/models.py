...
class Blog(models.Model):
	...
	date = models.DateField("Qo'shilgan vaqati", auto_now_add=True)
...
class Gallery(models.Model):
	title = models.CharField('Rasim matni',max_length=200,default='Imomi Azazm Rahmutullohi alayh jome masjid')
